...
export async function registerRoutes(app: Express): Promise<Server> {
    ...
    try {
      ...
      try {
        ...
        if (
          ...
          console.log(
            `Contact synced to Google Sheets successfully - exported ${result.exported} contacts`,
          );
        } else {
          console.log(
            "Google Sheets sync skipped - missing environment variables",
          );
        }
      } catch (syncError) {
  ...
  app.put("/api/contacts/:id", isAuthenticated, async (req, res) => {
    try {
      ...
      try {
        ...
        console.error(
          "Failed to sync updated contact to Google Sheets:",
          syncError,
        );
      }
  ...
  app.delete("/api/contacts/:id", isAuthenticated, async (req, res) => {
    try {
      ...
      try {
        ...
        console.error(
          "Failed to sync contact deletion to Google Sheets:",
          syncError,
        );
      }
  ...
  app.get(
    ...
    async (req, res) => {
      try {
        const interactions = await storage.getContactInteractions(
          req.params.id,
        );
    ...
    try {
      ...
      try {
        ...
        if (
          ...
          console.log(
            `Lead synced to Google Sheets successfully - exported ${result.exported} leads`,
          );
        }
      } catch (syncError) {
  ...
  app.put("/api/leads/:id", isAuthenticated, async (req, res) => {
    try {
      ...
      try {
        ...
        console.error(
          "Failed to sync updated lead to Google Sheets:",
          syncError,
        );
      }
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        const result =
          await airtableService.syncContactsFromAirtable(tableName);
  ...
  app.post(
    ...
    async (req, res) => {
      try {
        ...
        const tableName = req.body.tableName || "Contacts";
        const result =
          await airtableService.exportContactsToAirtable(tableName);
  ...
  app.post("/api/sync/google-sheets", isAuthenticated, async (req, res) => {
    try {
      ...
      console.log(
        `Manual sync completed - contacts: ${contactsResult.exported}, leads: ${leadsResult.exported}`,
      );
      res.json({
        success: true,
    ...
    try {
      ...
      if (!connectionResult.success) {
        return res.json({
          ...
          message: connectionResult.message,
          needsPermission:
            connectionResult.message.includes("not found") ||
            connectionResult.message.includes("no access"),
        });
      }
  ...
  app.post(
    "/api/google-sheets/import/contacts",
    isAuthenticated,
    async (req, res) => {
      try {
        const { GoogleSheetsService } = await import("./googleSheetsService");
  ...
  app.post(
    "/api/google-sheets/import/leads",
    isAuthenticated,
    async (req, res) => {
      try {
        const { GoogleSheetsService } = await import("./googleSheetsService");
  ...
  app.post(
    "/api/google-sheets/export/contacts",
    isAuthenticated,
    async (req, res) => {
      try {
        const { GoogleSheetsService } = await import("./googleSheetsService");
  ...
  app.post(
    "/api/google-sheets/export/leads",
    isAuthenticated,
    async (req, res) => {
      try {
